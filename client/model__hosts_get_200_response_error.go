...
// checks if the HostsGet200ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostsGet200ResponseError{}

// HostsGet200ResponseError struct for HostsGet200ResponseError
type HostsGet200ResponseError struct {
...
func (o HostsGet200ResponseError) MarshalJSON() ([]byte, error) {
...
func (o HostsGet200ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableHostsGet200ResponseError struct {
	value *HostsGet200ResponseError
	isSet bool
}

func (v NullableHostsGet200ResponseError) Get() *HostsGet200ResponseError {
	return v.value
}

func (v *NullableHostsGet200ResponseError) Set(val *HostsGet200ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableHostsGet200ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableHostsGet200ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostsGet200ResponseError(val *HostsGet200ResponseError) *NullableHostsGet200ResponseError {
	return &NullableHostsGet200ResponseError{value: val, isSet: true}
}

func (v NullableHostsGet200ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostsGet200ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
