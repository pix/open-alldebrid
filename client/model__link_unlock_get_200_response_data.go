...
// checks if the LinkUnlockGet200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkUnlockGet200ResponseData{}

// LinkUnlockGet200ResponseData struct for LinkUnlockGet200ResponseData
type LinkUnlockGet200ResponseData struct {
	...
	Streams []LinkUnlockGet200ResponseDataStreamsInner `json:"streams,omitempty"`
}
...
func NewLinkUnlockGet200ResponseData() *LinkUnlockGet200ResponseData {
	this := LinkUnlockGet200ResponseData{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *LinkUnlockGet200ResponseData) GetLinkOk() (*string, bool) {
	if o == nil || IsNil(o.Link) {
		return nil, false
	}
	return o.Link, true
...
func (o *LinkUnlockGet200ResponseData) GetStreams() []LinkUnlockGet200ResponseDataStreamsInner {
	if o == nil || IsNil(o.Streams) {
		var ret []LinkUnlockGet200ResponseDataStreamsInner
		return ret
	}
	return o.Streams
}
...
// SetStreams gets a reference to the given []LinkUnlockGet200ResponseDataStreamsInner and assigns it to the Streams field.
func (o *LinkUnlockGet200ResponseData) SetStreams(v []LinkUnlockGet200ResponseDataStreamsInner) {
	o.Streams = v
}

func (o LinkUnlockGet200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o LinkUnlockGet200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableLinkUnlockGet200ResponseData struct {
	value *LinkUnlockGet200ResponseData
	isSet bool
}

func (v NullableLinkUnlockGet200ResponseData) Get() *LinkUnlockGet200ResponseData {
	return v.value
}

func (v *NullableLinkUnlockGet200ResponseData) Set(val *LinkUnlockGet200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkUnlockGet200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkUnlockGet200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkUnlockGet200ResponseData(val *LinkUnlockGet200ResponseData) *NullableLinkUnlockGet200ResponseData {
	return &NullableLinkUnlockGet200ResponseData{value: val, isSet: true}
}

func (v NullableLinkUnlockGet200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkUnlockGet200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
