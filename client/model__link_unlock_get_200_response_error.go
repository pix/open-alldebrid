...
// checks if the LinkUnlockGet200ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkUnlockGet200ResponseError{}

// LinkUnlockGet200ResponseError struct for LinkUnlockGet200ResponseError
type LinkUnlockGet200ResponseError struct {
...
func NewLinkUnlockGet200ResponseError() *LinkUnlockGet200ResponseError {
	this := LinkUnlockGet200ResponseError{}
	return &this
}
...
func (o LinkUnlockGet200ResponseError) MarshalJSON() ([]byte, error) {
...
func (o LinkUnlockGet200ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableLinkUnlockGet200ResponseError struct {
	value *LinkUnlockGet200ResponseError
	isSet bool
}

func (v NullableLinkUnlockGet200ResponseError) Get() *LinkUnlockGet200ResponseError {
	return v.value
}

func (v *NullableLinkUnlockGet200ResponseError) Set(val *LinkUnlockGet200ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkUnlockGet200ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkUnlockGet200ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkUnlockGet200ResponseError(val *LinkUnlockGet200ResponseError) *NullableLinkUnlockGet200ResponseError {
	return &NullableLinkUnlockGet200ResponseError{value: val, isSet: true}
}

func (v NullableLinkUnlockGet200ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkUnlockGet200ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
