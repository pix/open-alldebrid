...
// checks if the LinkRedirectorGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkRedirectorGet200Response{}

// LinkRedirectorGet200Response struct for LinkRedirectorGet200Response
type LinkRedirectorGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *LinkRedirectorGet200ResponseData `json:"data,omitempty"`
	Error *LinkRedirectorGet200ResponseError `json:"error,omitempty"`
}
...
func NewLinkRedirectorGet200Response() *LinkRedirectorGet200Response {
	this := LinkRedirectorGet200Response{}
	return &this
}
...
func (o *LinkRedirectorGet200Response) GetData() LinkRedirectorGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret LinkRedirectorGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given LinkRedirectorGet200ResponseData and assigns it to the Data field.
...
func (o *LinkRedirectorGet200Response) GetError() LinkRedirectorGet200ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret LinkRedirectorGet200ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given LinkRedirectorGet200ResponseError and assigns it to the Error field.
func (o *LinkRedirectorGet200Response) SetError(v LinkRedirectorGet200ResponseError) {
	o.Error = &v
}

func (o LinkRedirectorGet200Response) MarshalJSON() ([]byte, error) {
...
func (o LinkRedirectorGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableLinkRedirectorGet200Response struct {
	value *LinkRedirectorGet200Response
	isSet bool
}

func (v NullableLinkRedirectorGet200Response) Get() *LinkRedirectorGet200Response {
	return v.value
}

func (v *NullableLinkRedirectorGet200Response) Set(val *LinkRedirectorGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkRedirectorGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkRedirectorGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkRedirectorGet200Response(val *LinkRedirectorGet200Response) *NullableLinkRedirectorGet200Response {
	return &NullableLinkRedirectorGet200Response{value: val, isSet: true}
}

func (v NullableLinkRedirectorGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkRedirectorGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
