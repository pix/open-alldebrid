...
// checks if the MagnetUploadFilePost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagnetUploadFilePost200Response{}

// MagnetUploadFilePost200Response struct for MagnetUploadFilePost200Response
type MagnetUploadFilePost200Response struct {
	Status *string `json:"status,omitempty"`
	Data *MagnetUploadFilePost200ResponseData `json:"data,omitempty"`
...
func NewMagnetUploadFilePost200Response() *MagnetUploadFilePost200Response {
	this := MagnetUploadFilePost200Response{}
	return &this
}
...
func (o *MagnetUploadFilePost200Response) GetData() MagnetUploadFilePost200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MagnetUploadFilePost200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MagnetUploadFilePost200ResponseData and assigns it to the Data field.
...
func (o MagnetUploadFilePost200Response) MarshalJSON() ([]byte, error) {
...
func (o MagnetUploadFilePost200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMagnetUploadFilePost200Response struct {
	value *MagnetUploadFilePost200Response
	isSet bool
}

func (v NullableMagnetUploadFilePost200Response) Get() *MagnetUploadFilePost200Response {
	return v.value
}

func (v *NullableMagnetUploadFilePost200Response) Set(val *MagnetUploadFilePost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMagnetUploadFilePost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMagnetUploadFilePost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagnetUploadFilePost200Response(val *MagnetUploadFilePost200Response) *NullableMagnetUploadFilePost200Response {
	return &NullableMagnetUploadFilePost200Response{value: val, isSet: true}
}

func (v NullableMagnetUploadFilePost200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagnetUploadFilePost200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
