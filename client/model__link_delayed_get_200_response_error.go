...
// checks if the LinkDelayedGet200ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkDelayedGet200ResponseError{}

// LinkDelayedGet200ResponseError struct for LinkDelayedGet200ResponseError
type LinkDelayedGet200ResponseError struct {
...
func NewLinkDelayedGet200ResponseError() *LinkDelayedGet200ResponseError {
	this := LinkDelayedGet200ResponseError{}
	return &this
}
...
func (o LinkDelayedGet200ResponseError) MarshalJSON() ([]byte, error) {
...
func (o LinkDelayedGet200ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableLinkDelayedGet200ResponseError struct {
	value *LinkDelayedGet200ResponseError
	isSet bool
}

func (v NullableLinkDelayedGet200ResponseError) Get() *LinkDelayedGet200ResponseError {
	return v.value
}

func (v *NullableLinkDelayedGet200ResponseError) Set(val *LinkDelayedGet200ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkDelayedGet200ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkDelayedGet200ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkDelayedGet200ResponseError(val *LinkDelayedGet200ResponseError) *NullableLinkDelayedGet200ResponseError {
	return &NullableLinkDelayedGet200ResponseError{value: val, isSet: true}
}

func (v NullableLinkDelayedGet200ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkDelayedGet200ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
