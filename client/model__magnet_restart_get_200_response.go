...
// checks if the MagnetRestartGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagnetRestartGet200Response{}

// MagnetRestartGet200Response struct for MagnetRestartGet200Response
type MagnetRestartGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *MagnetRestartGet200ResponseData `json:"data,omitempty"`
	Error *MagnetDeleteGet200ResponseError `json:"error,omitempty"`
}
...
func NewMagnetRestartGet200Response() *MagnetRestartGet200Response {
	this := MagnetRestartGet200Response{}
	return &this
}
...
func (o *MagnetRestartGet200Response) GetData() MagnetRestartGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MagnetRestartGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MagnetRestartGet200ResponseData and assigns it to the Data field.
...
func (o *MagnetRestartGet200Response) GetError() MagnetDeleteGet200ResponseError {
	if o == nil || IsNil(o.Error) {
		var ret MagnetDeleteGet200ResponseError
		return ret
	}
	return *o.Error
}
...
// SetError gets a reference to the given MagnetDeleteGet200ResponseError and assigns it to the Error field.
func (o *MagnetRestartGet200Response) SetError(v MagnetDeleteGet200ResponseError) {
	o.Error = &v
}

func (o MagnetRestartGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MagnetRestartGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMagnetRestartGet200Response struct {
	value *MagnetRestartGet200Response
	isSet bool
}

func (v NullableMagnetRestartGet200Response) Get() *MagnetRestartGet200Response {
	return v.value
}

func (v *NullableMagnetRestartGet200Response) Set(val *MagnetRestartGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMagnetRestartGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMagnetRestartGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagnetRestartGet200Response(val *MagnetRestartGet200Response) *NullableMagnetRestartGet200Response {
	return &NullableMagnetRestartGet200Response{value: val, isSet: true}
}

func (v NullableMagnetRestartGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagnetRestartGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
