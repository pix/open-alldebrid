...
// checks if the MagnetUploadGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagnetUploadGet200Response{}

// MagnetUploadGet200Response struct for MagnetUploadGet200Response
type MagnetUploadGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *MagnetUploadGet200ResponseData `json:"data,omitempty"`
...
func NewMagnetUploadGet200Response() *MagnetUploadGet200Response {
	this := MagnetUploadGet200Response{}
	return &this
}
...
func (o *MagnetUploadGet200Response) GetData() MagnetUploadGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MagnetUploadGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MagnetUploadGet200ResponseData and assigns it to the Data field.
...
func (o MagnetUploadGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MagnetUploadGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMagnetUploadGet200Response struct {
	value *MagnetUploadGet200Response
	isSet bool
}

func (v NullableMagnetUploadGet200Response) Get() *MagnetUploadGet200Response {
	return v.value
}

func (v *NullableMagnetUploadGet200Response) Set(val *MagnetUploadGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMagnetUploadGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMagnetUploadGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagnetUploadGet200Response(val *MagnetUploadGet200Response) *NullableMagnetUploadGet200Response {
	return &NullableMagnetUploadGet200Response{value: val, isSet: true}
}

func (v NullableMagnetUploadGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagnetUploadGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
