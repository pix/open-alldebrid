...
// checks if the LinkInfosGet200ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkInfosGet200ResponseError{}

// LinkInfosGet200ResponseError struct for LinkInfosGet200ResponseError
type LinkInfosGet200ResponseError struct {
...
func NewLinkInfosGet200ResponseError() *LinkInfosGet200ResponseError {
	this := LinkInfosGet200ResponseError{}
	return &this
}
...
func (o LinkInfosGet200ResponseError) MarshalJSON() ([]byte, error) {
...
func (o LinkInfosGet200ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableLinkInfosGet200ResponseError struct {
	value *LinkInfosGet200ResponseError
	isSet bool
}

func (v NullableLinkInfosGet200ResponseError) Get() *LinkInfosGet200ResponseError {
	return v.value
}

func (v *NullableLinkInfosGet200ResponseError) Set(val *LinkInfosGet200ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkInfosGet200ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkInfosGet200ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkInfosGet200ResponseError(val *LinkInfosGet200ResponseError) *NullableLinkInfosGet200ResponseError {
	return &NullableLinkInfosGet200ResponseError{value: val, isSet: true}
}

func (v NullableLinkInfosGet200ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkInfosGet200ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
