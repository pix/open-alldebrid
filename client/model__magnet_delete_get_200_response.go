...
// checks if the MagnetDeleteGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagnetDeleteGet200Response{}

// MagnetDeleteGet200Response struct for MagnetDeleteGet200Response
type MagnetDeleteGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *MagnetDeleteGet200ResponseData `json:"data,omitempty"`
...
func NewMagnetDeleteGet200Response() *MagnetDeleteGet200Response {
	this := MagnetDeleteGet200Response{}
	return &this
}
...
func (o *MagnetDeleteGet200Response) GetData() MagnetDeleteGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MagnetDeleteGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MagnetDeleteGet200ResponseData and assigns it to the Data field.
...
func (o MagnetDeleteGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MagnetDeleteGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMagnetDeleteGet200Response struct {
	value *MagnetDeleteGet200Response
	isSet bool
}

func (v NullableMagnetDeleteGet200Response) Get() *MagnetDeleteGet200Response {
	return v.value
}

func (v *NullableMagnetDeleteGet200Response) Set(val *MagnetDeleteGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMagnetDeleteGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMagnetDeleteGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagnetDeleteGet200Response(val *MagnetDeleteGet200Response) *NullableMagnetDeleteGet200Response {
	return &NullableMagnetDeleteGet200Response{value: val, isSet: true}
}

func (v NullableMagnetDeleteGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagnetDeleteGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
