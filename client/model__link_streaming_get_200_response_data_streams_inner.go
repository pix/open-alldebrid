...
// checks if the LinkStreamingGet200ResponseDataStreamsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkStreamingGet200ResponseDataStreamsInner{}

// LinkStreamingGet200ResponseDataStreamsInner struct for LinkStreamingGet200ResponseDataStreamsInner
type LinkStreamingGet200ResponseDataStreamsInner struct {
...
func NewLinkStreamingGet200ResponseDataStreamsInner() *LinkStreamingGet200ResponseDataStreamsInner {
	this := LinkStreamingGet200ResponseDataStreamsInner{}
	return &this
}
...
func (o *LinkStreamingGet200ResponseDataStreamsInner) HasQuality() bool {
	if o != nil && !IsNil(o.Quality) {
		return true
	}
...
func (o LinkStreamingGet200ResponseDataStreamsInner) MarshalJSON() ([]byte, error) {
...
func (o LinkStreamingGet200ResponseDataStreamsInner) ToMap() (map[string]interface{}, error) {
...
type NullableLinkStreamingGet200ResponseDataStreamsInner struct {
	value *LinkStreamingGet200ResponseDataStreamsInner
	isSet bool
}

func (v NullableLinkStreamingGet200ResponseDataStreamsInner) Get() *LinkStreamingGet200ResponseDataStreamsInner {
	return v.value
}

func (v *NullableLinkStreamingGet200ResponseDataStreamsInner) Set(val *LinkStreamingGet200ResponseDataStreamsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkStreamingGet200ResponseDataStreamsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkStreamingGet200ResponseDataStreamsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkStreamingGet200ResponseDataStreamsInner(val *LinkStreamingGet200ResponseDataStreamsInner) *NullableLinkStreamingGet200ResponseDataStreamsInner {
	return &NullableLinkStreamingGet200ResponseDataStreamsInner{value: val, isSet: true}
}

func (v NullableLinkStreamingGet200ResponseDataStreamsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkStreamingGet200ResponseDataStreamsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
