...
// checks if the LinkRedirectorGet200ResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkRedirectorGet200ResponseError{}

// LinkRedirectorGet200ResponseError struct for LinkRedirectorGet200ResponseError
type LinkRedirectorGet200ResponseError struct {
...
func NewLinkRedirectorGet200ResponseError() *LinkRedirectorGet200ResponseError {
	this := LinkRedirectorGet200ResponseError{}
	return &this
}
...
func (o LinkRedirectorGet200ResponseError) MarshalJSON() ([]byte, error) {
...
func (o LinkRedirectorGet200ResponseError) ToMap() (map[string]interface{}, error) {
...
type NullableLinkRedirectorGet200ResponseError struct {
	value *LinkRedirectorGet200ResponseError
	isSet bool
}

func (v NullableLinkRedirectorGet200ResponseError) Get() *LinkRedirectorGet200ResponseError {
	return v.value
}

func (v *NullableLinkRedirectorGet200ResponseError) Set(val *LinkRedirectorGet200ResponseError) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkRedirectorGet200ResponseError) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkRedirectorGet200ResponseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkRedirectorGet200ResponseError(val *LinkRedirectorGet200ResponseError) *NullableLinkRedirectorGet200ResponseError {
	return &NullableLinkRedirectorGet200ResponseError{value: val, isSet: true}
}

func (v NullableLinkRedirectorGet200ResponseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkRedirectorGet200ResponseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
