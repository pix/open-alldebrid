...
// checks if the LinkUnlockGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkUnlockGet200Response{}

// LinkUnlockGet200Response struct for LinkUnlockGet200Response
type LinkUnlockGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *LinkUnlockGet200ResponseData `json:"data,omitempty"`
...
func (o *LinkUnlockGet200Response) GetData() LinkUnlockGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret LinkUnlockGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given LinkUnlockGet200ResponseData and assigns it to the Data field.
...
func (o LinkUnlockGet200Response) MarshalJSON() ([]byte, error) {
...
func (o LinkUnlockGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableLinkUnlockGet200Response struct {
	value *LinkUnlockGet200Response
	isSet bool
}

func (v NullableLinkUnlockGet200Response) Get() *LinkUnlockGet200Response {
	return v.value
}

func (v *NullableLinkUnlockGet200Response) Set(val *LinkUnlockGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkUnlockGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkUnlockGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkUnlockGet200Response(val *LinkUnlockGet200Response) *NullableLinkUnlockGet200Response {
	return &NullableLinkUnlockGet200Response{value: val, isSet: true}
}

func (v NullableLinkUnlockGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkUnlockGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
