...
// checks if the HostsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostsGet200Response{}

// HostsGet200Response struct for HostsGet200Response
type HostsGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *HostsGet200ResponseData `json:"data,omitempty"`
...
func (o *HostsGet200Response) GetData() HostsGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret HostsGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given HostsGet200ResponseData and assigns it to the Data field.
...
func (o HostsGet200Response) MarshalJSON() ([]byte, error) {
...
func (o HostsGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableHostsGet200Response struct {
	value *HostsGet200Response
	isSet bool
}

func (v NullableHostsGet200Response) Get() *HostsGet200Response {
	return v.value
}

func (v *NullableHostsGet200Response) Set(val *HostsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableHostsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableHostsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostsGet200Response(val *HostsGet200Response) *NullableHostsGet200Response {
	return &NullableHostsGet200Response{value: val, isSet: true}
}

func (v NullableHostsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
