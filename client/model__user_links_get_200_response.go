...
// checks if the UserLinksGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserLinksGet200Response{}

// UserLinksGet200Response struct for UserLinksGet200Response
type UserLinksGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *UserLinksGet200ResponseData `json:"data,omitempty"`
...
func (o *UserLinksGet200Response) GetData() UserLinksGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret UserLinksGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given UserLinksGet200ResponseData and assigns it to the Data field.
...
func (o UserLinksGet200Response) MarshalJSON() ([]byte, error) {
...
func (o UserLinksGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableUserLinksGet200Response struct {
	value *UserLinksGet200Response
	isSet bool
}

func (v NullableUserLinksGet200Response) Get() *UserLinksGet200Response {
	return v.value
}

func (v *NullableUserLinksGet200Response) Set(val *UserLinksGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUserLinksGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUserLinksGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserLinksGet200Response(val *UserLinksGet200Response) *NullableUserLinksGet200Response {
	return &NullableUserLinksGet200Response{value: val, isSet: true}
}

func (v NullableUserLinksGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserLinksGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
