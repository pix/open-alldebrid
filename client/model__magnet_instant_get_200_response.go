...
// checks if the MagnetInstantGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagnetInstantGet200Response{}

// MagnetInstantGet200Response struct for MagnetInstantGet200Response
type MagnetInstantGet200Response struct {
	Status *string `json:"status,omitempty"`
	Data *MagnetInstantGet200ResponseData `json:"data,omitempty"`
...
func NewMagnetInstantGet200Response() *MagnetInstantGet200Response {
	this := MagnetInstantGet200Response{}
	return &this
}
...
func (o *MagnetInstantGet200Response) GetData() MagnetInstantGet200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret MagnetInstantGet200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given MagnetInstantGet200ResponseData and assigns it to the Data field.
...
func (o MagnetInstantGet200Response) MarshalJSON() ([]byte, error) {
...
func (o MagnetInstantGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMagnetInstantGet200Response struct {
	value *MagnetInstantGet200Response
	isSet bool
}

func (v NullableMagnetInstantGet200Response) Get() *MagnetInstantGet200Response {
	return v.value
}

func (v *NullableMagnetInstantGet200Response) Set(val *MagnetInstantGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMagnetInstantGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMagnetInstantGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMagnetInstantGet200Response(val *MagnetInstantGet200Response) *NullableMagnetInstantGet200Response {
	return &NullableMagnetInstantGet200Response{value: val, isSet: true}
}

func (v NullableMagnetInstantGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMagnetInstantGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
